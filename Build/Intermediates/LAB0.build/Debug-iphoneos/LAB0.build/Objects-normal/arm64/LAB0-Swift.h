...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LAB0",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4LAB011AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC4LAB013SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC4LAB014ViewController")
...
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified yearSegmentedController;
...
- (IBAction)introduceSelfDidTapped:(id _Nonnull)sender;
- (void)viewDidLoad;
